...
type PropsType = {
  ...
  removeItemString: string | null | undefined
  setOpen: (open: boolean) => void
}

const CartItem = memo(
  function CartItem({ lineItem, removeItemString, setOpen }: PropsType) {
    ...
    if (product) {
      ...
      return (
        <>
          <li key={lineItem.key} className="py-6 flex items-center">
            {product.image && (
